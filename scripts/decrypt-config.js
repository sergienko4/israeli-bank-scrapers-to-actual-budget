 ...
 * Usage: CREDENTIALS_ENCRYPTION_PASSWORD=<your-key> node scripts/decrypt-config.js [input]
 */
...
if (!password) {
  ...
  console.error('   Example: CREDENTIALS_ENCRYPTION_PASSWORD=<your-key> node scripts/decrypt-config.js');
  process.exit(1);
}
