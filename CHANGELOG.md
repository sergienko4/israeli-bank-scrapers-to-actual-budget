...
* **deps:** bump @sergienko4/israeli-bank-scrapers from 8.7.2 to 8.7.3 ([#707](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/707)) ([e78afc0](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/e78afc06982190d91591621e9aa3fa5df162a3dd))
...
* adapt to scraper 8.7.1 contracts ([#693](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/693)) ([ec9af5b](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/ec9af5b697a8072e2376f1e2f374c9cb6122c74f))
* **deps:** bump @sergienko4/israeli-bank-scrapers from 8.7.0 to 8.7.1 ([#690](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/690)) ([8ea3f68](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/8ea3f68611ed4e2f78bac31c17347b6c1c2eacd4))
* **deps:** bump fastify from 5.12.3 to 5.12.4 ([#691](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/691)) ([d53dee6](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/d53dee61f3af76a02aad8a615887463e4358e320))

## [1.42.22](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/compare/v1.42.21...v1.42.22) (2026-09-10)


### Fixed

* **deps:** clear blocking audit advisories ([#684](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/684)) ([a724466](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/a72446674ee9b248ab47fa6f99564bf67a5f20f8))
* **deps:** refresh 3 runtime and 14 dev lockfile pins ([#687](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/687)) ([2e9d5bf](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/2e9d5bf8fbd0dc0c1fa900f181012b21bbf13aa3))

## [1.42.21](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/compare/v1.42.20...v1.42.21) (2026-09-08)


### Fixed

* **deps:** bump fastify from 5.12.1 to 5.12.3 ([#678](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/678)) ([2dcb479](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/2dcb479aaf55284193df64bb45333cde3a1b5ab1))

## [1.42.20](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/compare/v1.42.19...v1.42.20) (2026-09-03)


### Fixed

* **deps:** bump @actual-app/api from 26.8.1 to 26.9.0 ([#669](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/669)) ([55cce25](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/55cce25bbc69a71534c2a36b02cf078e6d8b9287))
* **deps:** bump scrapers to 8.7.0, drop removed options ([#676](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/676)) ([cb7d48c](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/cb7d48c0fd807e89ef44adb85f17552b3933b99e))
* **deps:** clear all blocking security advisories ([#672](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/672)) ([611ceb8](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/611ceb85823e420f83063ec63caff880624f01b5))
...
* **deps:** bump @sergienko4/israeli-bank-scrapers from 8.6.7 to 8.6.8 ([#640](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/640)) ([9f7e46e](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/9f7e46e05199bb7545672134e55896881a23ab7d))
...
* **deps:** bump cron-parser from 5.8.1 to 5.10.0 ([#623](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/623)) ([d14bcca](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/d14bccab2607b8992bd191884645349cc581b680))
* **deps:** bump fastify from 5.11.3 to 5.12.0 ([#621](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/621)) ([3f0eeab](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/3f0eeabe214f9015763e5d7edc392831f7a75728))

## [1.42.10](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/compare/v1.42.9...v1.42.10) (2026-08-11)


### Fixed

* **deps:** bump @sergienko4/israeli-bank-scrapers from 8.6.5 to 8.6.6 ([#618](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/618)) ([2168084](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/2168084585eae67cdac1cf7e09ab0fccf1e0a884))
* **deps:** bump cron-parser from 5.7.0 to 5.8.1 ([#615](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/615)) ([b98322a](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/b98322aa44643a5cba4b13f20184fef52b335fe7))

## [1.42.9](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/compare/v1.42.8...v1.42.9) (2026-08-09)


### Fixed

* **deps:** bump @fastify/static from 10.1.2 to 10.1.3 ([#611](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/611)) ([4bb7447](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/4bb74475d49172d5960da209d707465610b39d38))
* **deps:** bump fastify from 5.11.2 to 5.11.3 ([#609](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/609)) ([94be75a](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/94be75a03f4c5a44c753c8a425736d2f37860803))
...
* **deps:** bump cron-parser from 5.6.2 to 5.7.0 ([#580](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/580)) ([0519480](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/05194805c011a2390144b5138243bd1f4066df45))
* **deps:** bump scraper to 8.6.3 for memory fixes ([#582](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/582)) ([5f9fbaf](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/5f9fbaf6bd0538b296b1c2676f8cc328e559f186))
...
* **deps:** bump israeli-bank-scrapers to 8.6.2 ([#574](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/574)) ([b231c62](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/b231c627c17bdd6c16182fca38cee375f3770e89))
* **deps:** patch advisories and always release shipped bumps ([#572](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/572)) ([fd39696](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/fd396961a91a500da08cdccf7111ce74fc4813eb))
...
* **deps:** bump @sergienko4/israeli-bank-scrapers to 8.5.0 ([#504](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/504)) ([f5f39ec](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/f5f39ec179f9d969bca2b2487966363705b3cf8c))

## [1.39.0](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/compare/v1.38.7...v1.39.0) (2026-07-03)


### Added

* add config web portal (mobile + desktop) ([#492](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/492)) ([2cffdcd](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/2cffdcdaf35ef013972fd0f19537ffb67948b513))


### Fixed

* **deps:** update critical dependencies ([#495](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/495)) ([d553381](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/d553381a3acb941eafcb4dd325fed0e2fa5cdcd6))
...
* **deps:** update critical dependencies ([#406](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/406)) ([5ab4924](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/5ab4924f1deb8b69126f57a32972741d9987759f))
...
* **deps:** update critical dependencies ([#367](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/367)) ([edb4318](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/edb43189a35d2d679fd653ed38697e0bcb270cc6))

## [1.37.14](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/compare/v1.37.13...v1.37.14) (2026-05-20)


### Fixed

* **deps:** update critical dependencies ([#365](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/365)) ([c79f8de](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/c79f8de7eacce1af6717181e4adb17bf9ca9c791))
...
* **deps-dev:** bump @biomejs/biome from 2.4.14 to 2.4.15 ([#336](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/336)) ([2bb7060](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/2bb7060f932750d9f9c3376eeca04e85aeda9f49))
* **deps-dev:** bump @types/node from 25.6.0 to 25.6.2 ([#333](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/333)) ([491e2b2](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/491e2b207c0bcd1985076fb6af7cc1216ad66001))
* **deps-dev:** bump eslint-plugin-n from 17.24.0 to 18.0.1 ([#335](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/335)) ([b0046da](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/b0046da76c9921b84f067b3f5e87a3134c2adfc3))
* **deps-dev:** bump lint-staged from 16.4.0 to 17.0.4 ([#337](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/337)) ([1d4d293](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/1d4d2937592a4f863e376bec9cbbfaff81d1ae05))
* **deps-dev:** bump vite from 8.0.10 to 8.0.12 ([#334](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/334)) ([51873b0](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/51873b0bfc7cc9b51dd049c1a16124c4c488a8d2))
* **deps:** update critical dependencies ([#332](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/issues/332)) ([e2db41b](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/commit/e2db41b6d46dab36cc2268774fb8062fb0ecc3e4))
