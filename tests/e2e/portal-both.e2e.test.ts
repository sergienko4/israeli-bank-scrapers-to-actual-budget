...
/**
 * Tears down the fixture: context, servers, temp dir, and env seam.
 * @param fx - The fixture to dispose.
 */
async function stopBoth(fx: IBothFixture): Promise<void> {
