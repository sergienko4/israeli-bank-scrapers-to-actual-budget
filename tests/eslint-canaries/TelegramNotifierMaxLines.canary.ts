// Canary: should trigger `max-lines: 200` cap on TelegramNotifier.ts.
//
// The PR 5 rule (Section 7e of eslint.config.mjs) tightens `max-lines`
// from the default 300 down to 200 for:
//   - src/Services/Notifications/TelegramNotifier.ts
//   - tests/eslint-canaries/TelegramNotifierMaxLines.canary.ts  <- this file
//
// After PR 5, TelegramNotifier.ts is a thin orchestrator (~187 LoC) that
// wires three peers: TelegramApiClient (HTTP I/O), TelegramFormatter
// (markup), TelegramHtml (utils), and delegates OTP polling to
// TelegramOtpPoller. Adding a new notifier action MUST go to one of those
// peer modules. Anything heavier (rate-limit, dry-run gate, retry policy)
// MUST become a new module under `src/Services/Notifications/*`.
//
// This canary exceeds 200 effective LoC so the canary harness can prove the
...
export const fakeConst221 = 221;
export const fakeConst222 = 222;
export const fakeConst223 = 223;
export const fakeConst224 = 224;
export const fakeConst225 = 225;
export const fakeConst226 = 226;
export const fakeConst227 = 227;
export const fakeConst228 = 228;
export const fakeConst229 = 229;
export const fakeConst230 = 230;
