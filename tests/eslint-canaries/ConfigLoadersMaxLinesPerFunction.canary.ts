...
// for src/Config/Loaders/**.
//
// The chore(eslint) commit that locks the Config/Loaders cluster adds
// Section 7w to eslint.config.mjs that tightens `max-lines-per-function`
// from the default 20 down to 10 for:
//   - src/Config/Loaders/**/*.ts
//   - tests/eslint-canaries/ConfigLoadersMaxLinesPerFunction.canary.ts ← this file
//
...
//
// Any new file landing under src/Config/Loaders/** MUST keep every
