...
// for src/Services/Telegram/**.
//
// The chore(eslint) commit that locks the Services/Telegram cluster adds
// Section 7ab to eslint.config.mjs that tightens `max-lines-per-function`
// from the default 20 down to 10 for:
//   - src/Services/Telegram/**/*.ts
//   - tests/eslint-canaries/ServicesTelegramMaxLinesPerFunction.canary.ts ← this file
//
...
//
// Any new file landing under src/Services/Telegram/** MUST keep every
