...
// for src/Services/Account/**.
//
// The chore(eslint) commit that locks the Services/Account cluster adds
// Section 7y to eslint.config.mjs that tightens `max-lines-per-function`
// from the default 20 down to 10 for:
//   - src/Services/Account/**/*.ts
//   - tests/eslint-canaries/ServicesAccountMaxLinesPerFunction.canary.ts ← this file
//
...
//
// Any new file landing under src/Services/Account/** MUST keep every
