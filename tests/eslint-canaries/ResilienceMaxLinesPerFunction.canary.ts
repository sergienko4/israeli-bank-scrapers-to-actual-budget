...
// for src/Resilience/**.
//
// The chore(eslint) commit that locks the Resilience cluster adds
// Section 7ac to eslint.config.mjs that tightens `max-lines-per-function`
// from the default 20 down to 10 for:
//   - src/Resilience/**/*.ts
//   - tests/eslint-canaries/ResilienceMaxLinesPerFunction.canary.ts ← this file
//
...
//
// Any new file landing under src/Resilience/** MUST keep every
