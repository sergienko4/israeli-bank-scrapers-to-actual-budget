...
// for src/Services/Import/**.
//
// The chore(eslint) commit that locks the Services/Import cluster adds
// Section 7aa to eslint.config.mjs that tightens `max-lines-per-function`
// from the default 20 down to 10 for:
//   - src/Services/Import/**/*.ts
//   - tests/eslint-canaries/ServicesImportMaxLinesPerFunction.canary.ts ← this file
//
...
//
// Any new file landing under src/Services/Import/** MUST keep every
