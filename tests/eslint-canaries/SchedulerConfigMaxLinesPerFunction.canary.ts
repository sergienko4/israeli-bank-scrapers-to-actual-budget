// Canary: PR #433 — must trigger `max-lines-per-function: 10`
// for src/Scheduler/Config/**.
//
// The chore(eslint) commit on PR #433 adds Section 7i to
// eslint.config.mjs that tightens `max-lines-per-function` from the
// default 20 down to 10 for:
//   - src/Scheduler/Config/**/*.ts
//   - tests/eslint-canaries/SchedulerConfigMaxLinesPerFunction.canary.ts ← this file
//
...
//
// Any new file landing under src/Scheduler/Config/** MUST keep every
