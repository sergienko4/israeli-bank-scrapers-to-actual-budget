...
// for src/Services/Transaction/**.
//
// The chore(eslint) commit that locks the Services/Transaction cluster adds
// Section 7z to eslint.config.mjs that tightens `max-lines-per-function`
// from the default 20 down to 10 for:
//   - src/Services/Transaction/**/*.ts
//   - tests/eslint-canaries/ServicesTransactionMaxLinesPerFunction.canary.ts ← this file
//
...
//
// Any new file landing under src/Services/Transaction/** MUST keep every
