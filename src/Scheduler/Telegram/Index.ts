 ...
 * (CommandRegistry, ConfigHelpers, HandlerFactory, MediatorFactory,
 * PollerWiring, ReceiptHandlerFactory) so consumers can pick the
 * sub-module they need without each one having its own deep import path.
 */
