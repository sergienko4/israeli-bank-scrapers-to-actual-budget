# Supported Banks (moved)

> **This page has moved.** The bank reference is now in [docs/banks/](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/blob/main/docs/banks/index.md), with one page per institution.

## Where to find each bank

| Bank | Page |
|------|------|
| Bank Hapoalim | [banks/hapoalim.md](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/blob/main/docs/banks/hapoalim.md) |
| Bank Leumi | [banks/leumi.md](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/blob/main/docs/banks/leumi.md) |
| Discount Bank | [banks/discount.md](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/blob/main/docs/banks/discount.md) |
...
| Beyahad Bishvilha | [banks/beyahadBishvilha.md](https://github.com/sergienko4/israeli-bank-scrapers-to-actual-budget/blob/main/docs/banks/beyahadBishvilha.md) |
